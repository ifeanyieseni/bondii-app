...
import { Plus, Bluetooth, MoreVertical, File, Folder, FolderOpen, Code, MoreHorizontal, Search, Save, Download, Eye, Layout, Palette, Sun, Moon, Monitor, User, CreditCard, Settings, Keyboard, Globe, Bell, Mail, Shield, CircleHelp, FileText, LogOut, ChevronDown, Check } from "lucide-react"
        ...
        <CardFooter>
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button>
                <Plus strokeWidth={2} className="size-4 mr-2" />
                Show Dialog
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent size="sm">
              <AlertDialogHeader>
                <AlertDialogMedia>
                  <Bluetooth strokeWidth={2} className="size-4" />
                </AlertDialogMedia>
                    ...
                    <DropdownMenuPortal>
                      <DropdownMenuSubContent>
                        <DropdownMenuGroup>
                          ...
                          <DropdownMenuItem>
                            <Globe strokeWidth={2} className="size-4" />
                            Language
                          </DropdownMenuItem>
                          <DropdownMenuSub>
                            <DropdownMenuSubTrigger>
